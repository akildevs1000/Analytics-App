<template>
  <div style="width: 101%; min-width: 500px">
    <v-col style="margin-top: -27px; width: 99%; padding: 0px">
      <!-- <fieldset 
      style=" width: 100%; border: 1px solid #a1a1a1; border-radius: 11px;
      height: 130px; " >-->
      ...
      <div class="text-center" style="width: 100%; margin: auto">
        <v-row class="text-center">
          ...
          <v-col cols="1" class="pt-0">
            <img src="../../static/icons/employee-in.png" style="width: 40px" />
