...
export default {
    ...
    data() {
      try {
        this.chartOptions1.series = [
          parseInt(this.data.male_younger_count),
          parseInt(this.data.male_adult_count),
          parseInt(this.data.male_senior_count),
        ];
  ...
  mounted() {
    setTimeout(() => {
      console.log("chartOptions1", this.data.male_younger_count);
      ...
      //this.chartOptions1.series[0] = this.data.male_younger_count;
      // this.chartOptions1.series[1] = this.data.male_adult_count;
      //this.chartOptions1.series[2] = this.data.male_senior_count;

      // this.chartOptions1.labels = ["Younger", "Adult", "Senior"];
